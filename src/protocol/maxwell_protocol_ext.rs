...
pub fn set_round_ref(protocol_msg: &mut ProtocolMsg, round_ref: u32) -> &ProtocolMsg {
  match protocol_msg {
    ...
    ProtocolMsg::PingReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::PingRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::PushReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::PushRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::PullReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::PullRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::ReqReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::ReqRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::AuthReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::AuthRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::OkRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::ErrorRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::Ok2Rep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::Error2Rep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RegisterFrontendReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RegisterFrontendRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RegisterBackendReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RegisterBackendRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RegisterServerReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RegisterServerRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::AddRoutesReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::AddRoutesRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::GetRoutesReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::GetRoutesRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RouteAddedMsg(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RouteDeletedMsg(msg) => msg.round_ref = round_ref,
    ProtocolMsg::RouteStatusChangedMsg(msg) => msg.round_ref = round_ref,
    ProtocolMsg::AssignFrontendReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::AssignFrontendRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::LocateTopicReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::LocateTopicRep(msg) => msg.round_ref = round_ref,
    ProtocolMsg::ResolveIpReq(msg) => msg.round_ref = round_ref,
    ProtocolMsg::ResolveIpRep(msg) => msg.round_ref = round_ref,
  }
  protocol_msg
}
...
pub fn get_round_ref(protocol_msg: &ProtocolMsg) -> u32 {
  match protocol_msg {
    ...
    ProtocolMsg::PingReq(msg) => msg.round_ref,
    ProtocolMsg::PingRep(msg) => msg.round_ref,
    ProtocolMsg::PushReq(msg) => msg.round_ref,
    ProtocolMsg::PushRep(msg) => msg.round_ref,
    ProtocolMsg::PullReq(msg) => msg.round_ref,
    ProtocolMsg::PullRep(msg) => msg.round_ref,
    ProtocolMsg::ReqReq(msg) => msg.round_ref,
    ProtocolMsg::ReqRep(msg) => msg.round_ref,
    ProtocolMsg::AuthReq(msg) => msg.round_ref,
    ProtocolMsg::AuthRep(msg) => msg.round_ref,
    ProtocolMsg::OkRep(msg) => msg.round_ref,
    ProtocolMsg::ErrorRep(msg) => msg.round_ref,
    ProtocolMsg::Ok2Rep(msg) => msg.round_ref,
    ProtocolMsg::Error2Rep(msg) => msg.round_ref,
    ProtocolMsg::RegisterFrontendReq(msg) => msg.round_ref,
    ProtocolMsg::RegisterFrontendRep(msg) => msg.round_ref,
    ProtocolMsg::RegisterBackendReq(msg) => msg.round_ref,
    ProtocolMsg::RegisterBackendRep(msg) => msg.round_ref,
    ProtocolMsg::RegisterServerReq(msg) => msg.round_ref,
    ProtocolMsg::RegisterServerRep(msg) => msg.round_ref,
    ProtocolMsg::AddRoutesReq(msg) => msg.round_ref,
    ProtocolMsg::AddRoutesRep(msg) => msg.round_ref,
    ProtocolMsg::GetRoutesReq(msg) => msg.round_ref,
    ProtocolMsg::GetRoutesRep(msg) => msg.round_ref,
    ProtocolMsg::RouteAddedMsg(msg) => msg.round_ref,
    ProtocolMsg::RouteDeletedMsg(msg) => msg.round_ref,
    ProtocolMsg::RouteStatusChangedMsg(msg) => msg.round_ref,
    ProtocolMsg::AssignFrontendReq(msg) => msg.round_ref,
    ProtocolMsg::AssignFrontendRep(msg) => msg.round_ref,
    ProtocolMsg::LocateTopicReq(msg) => msg.round_ref,
    ProtocolMsg::LocateTopicRep(msg) => msg.round_ref,
    ProtocolMsg::ResolveIpReq(msg) => msg.round_ref,
    ProtocolMsg::ResolveIpRep(msg) => msg.round_ref,
  }
}